...
from .utils_baseline import NestedTensor, nested_tensor_from_tensor_list
from .transformer import build_transformer


class Caption(nn.Module):
    def __init__(self, encodeur, transformer, hidden_dim, vocab_size):
        super().__init__()
        self.backbone = encodeur
