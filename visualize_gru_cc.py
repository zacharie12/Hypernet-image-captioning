...
if __name__ == "__main__":
    ...
    model_path = '/cortex/users/cohenza4/checkpoint/GRU/no_emb/epoch=49-step=8149.ckpt'
    save_path = '/home/lab/cohenza4/www/CC_gru_no_emb.html'
    ...
    model = model.load_from_checkpoint(model_path, vocab=vocab, list_domain=list_domain)
    ...
    for imgs, caps, lengths, domains, img_name in test_loader:
        ...
        cap , _= model.captioner(img_feats, caps.long(), 0.0)
