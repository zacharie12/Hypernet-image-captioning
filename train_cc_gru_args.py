...
if __name__ == "__main__":
    ...
    save_path = "/cortex/users/cohenza4/checkpoint/GRU/debug/"
    ...
    model = Gru(200, 200, 200, len(vocab), vocab, list_domain, lr, domain_emb)
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='/cortex/users/cohenza4/GRU/', monitor="val_loss with TF")
