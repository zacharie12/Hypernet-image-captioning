...
class CiderScorer(object):
    ...
    def __init__(self, df_mode="corpus", test=None, refs=None, n=4, sigma=6.0):
        ...
        if self.df_mode != "corpus":
            self.document_frequency = six.moves.cPickle.load(open(os.path.join('data', df_mode + '.p'),'rb'), **(dict(encoding='latin1') if six.PY3 else {}))
    ...
    def compute_score(self, option=None, verbose=0):
        ...
        if self.df_mode == "corpus":
            ...
            try:
                ...
                return np.mean(np.array(0.0)), np.array(0.0)
